...
export function DitheredCta({
  ...
  return (
    <Link
      href={href}
      className="group relative inline-flex items-center gap-2 overflow-hidden rounded-[10px] border-4 border-[#99D892]/30 bg-[#99D892]/15 px-8 py-4 text-[17px] font-semibold text-[#A0DC99] no-underline shadow-[0_0_0_1px_rgba(159,222,152,0.7),inset_0_1px_3px_rgba(0,0,0,0.18)] backdrop-blur-md transition-colors hover:bg-[#99D892]/25"
    >
      <span
